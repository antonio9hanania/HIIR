...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.GoogleMaps.Clustering.Android.ClusterRenderer, Xamarin.Forms.GoogleMaps.Clustering.Android", ClusterRenderer.class, __md_methods);
	}
	...
	public ClusterRenderer (android.content.Context p0, com.google.android.gms.maps.GoogleMap p1, com.google.maps.android.clustering.ClusterManager p2)
	{
		...
		if (getClass () == ClusterRenderer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.GoogleMaps.Clustering.Android.ClusterRenderer, Xamarin.Forms.GoogleMaps.Clustering.Android", "Android.Content.Context, Mono.Android:Android.Gms.Maps.GoogleMap, Xamarin.GooglePlayServices.Maps:Com.Google.Maps.Android.Clustering.ClusterManager, GoogleMapsUtility", this, new java.lang.Object[] { p0, p1, p2 });
	}
