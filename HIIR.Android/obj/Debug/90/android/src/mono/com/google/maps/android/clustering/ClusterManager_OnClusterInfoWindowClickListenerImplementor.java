...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Maps.Android.Clustering.ClusterManager+IOnClusterInfoWindowClickListenerImplementor, GoogleMapsUtility", ClusterManager_OnClusterInfoWindowClickListenerImplementor.class, __md_methods);
	}
	...
	public ClusterManager_OnClusterInfoWindowClickListenerImplementor ()
	{
		...
		if (getClass () == ClusterManager_OnClusterInfoWindowClickListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Google.Maps.Android.Clustering.ClusterManager+IOnClusterInfoWindowClickListenerImplementor, GoogleMapsUtility", "", this, new java.lang.Object[] {  });
	}
