...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Maps.Android.Clustering.ClusterManager+IOnClusterItemInfoWindowClickListenerImplementor, GoogleMapsUtility", ClusterManager_OnClusterItemInfoWindowClickListenerImplementor.class, __md_methods);
	}
	...
	public ClusterManager_OnClusterItemInfoWindowClickListenerImplementor ()
	{
		...
		if (getClass () == ClusterManager_OnClusterItemInfoWindowClickListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Google.Maps.Android.Clustering.ClusterManager+IOnClusterItemInfoWindowClickListenerImplementor, GoogleMapsUtility", "", this, new java.lang.Object[] {  });
	}
